...
Blender MCP may execute Blender Python inside a live Blender session. This is powerful and potentially destructive. Save work before running large modifications, and do not execute code that reads unrelated files, uses the network unexpectedly, deletes many objects, or stores credentials.
